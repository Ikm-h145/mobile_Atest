...
import jp.ac.meijou.android.s241205145.databinding.ActivityMain5Binding;
import jp.ac.meijou.android.s241205145.databinding.ActivityMain6Binding;
import okhttp3.Call;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button25.setOnClickListener(view -> {
            ...
            var url= Uri.parse("https://placehold.jp/500x500.png")
                    .buildUpon()
                    .appendQueryParameter("text",text1)
                    .build()
                    .toString();
            getImage(url);
        });
